  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 z-index-0" id="sidenav-main ">
    ...
    <div class=" w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../articles_pages/articles.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <div class="col">
                ...
                <form action="" method="get">
                  ...
                  <div class="input-group mt-1 d-flex align-items-start">
                    <input type="search" class="form-control box-sizing inline-block" placeholder="搜尋" aria-label="Recipient's username" aria-describedby="button-addon2" name="search" <?php if (isset($_GET["search"])) : $searchValue = $_GET["search"]; ?> value="<?= $searchValue ?>" <?php endif; ?>>
                  ...
                  <table class="table align-items-center mb-0  text-md">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center text-secondary opacity-7">標題</th>
                        <th class=" text-center text-secondary opacity-7">分類</th>
                        <th class="text-center text-secondary opacity-7">發文者</th>
                        <th class="text-center text-secondary opacity-7">更新時間</th>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="ml-5 ">
                            <p class="text-secondary mb-0 text-center"><?= $article["title"] ?></p>
                          </td>
                          <td>
                            <p class=" text-secondary mb-0 text-center"><?= $article["category_name"] ?></p>
                          </td>
                          <td>
                            <p class=" text-secondary mb-0 text-center"><?= $article["user_name"] ?></p>
                          </td>
                          <td>
                            <p class="text-secondary mb-0 text-center"><?= $article["update"] ?></p>
                          </td>
                          <td>
                            <!-- 按鈕 -->
                            <div class="d-flex justify-content-center align-items-center">
                              <button class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop<?= $article["id"] ?>"><i class="fa-solid fa-eye fa-fw"></i></button>
                              <!-- <button class="btn btn-success me-2" data-bs-toggle="modal" data-bs-target="#editModal<?= $article["id"] ?>"><i class="fa-solid fa-pen-to-square fa-fw"></i></button> -->
