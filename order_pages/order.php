                  ...
                  <div class="me-2">
                    ...
                    <div class="btn-group">
                      <a class="btn btn-primary <?php if ($order == 1)
                                                  echo "active" ?>" href="tables.php?order=1&p=<?= $p ?>">id<i class="fa-solid fa-arrow-down-wide-short fa-fw"></i></a>
                      <a class="btn btn-primary <?php if ($order == 2)
                                                  echo "active" ?>" href="tables.php?order=2&p=<?= $p ?>">id<i class="fa-solid fa-arrow-down-wide-short fa-fw"></i></a>
